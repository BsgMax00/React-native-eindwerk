...
import {HeroDataProvider, useHeroDataContext} from "./context/HeroContext";
...
function ProvidedApp(){
    const {count} = useHeroDataContext();

    return(
        <Stack.Navigator>
            <Stack.Screen name={NAV_HOME} component={HomeScreen} options={{title: "Homepage", headerStyle: styles.header, headerTitleAlign: "center"}}/>
            <Stack.Screen name={NAV_HEROES} component={HeroPage} options={{title: (count) + " characters", headerStyle: styles.header, headerTitleAlign: "center"}}/>
